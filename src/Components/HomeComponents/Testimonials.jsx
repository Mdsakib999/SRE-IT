      ...
      <div>
        ...
        >
          {testimonials.map(({ id, name, position, image, testimonial }) => (
            <SwiperSlide key={id}>
              <div className="border h-[360px]  p-6 my-10 mx-3 rounded-xl shadow-xl flex flex-col justify-between transform transition-transform hover:-translate-y-3 duration-500  ">
                <div className="mb-6 ">
                  <FaQuoteLeft
                    className="text-[#d74c0c82] mb-4 animate-shake"
                    size={36}
                  />
