  ...
  return (
    <div className="md:mb-6">
      <div className="  bg-neutral-50 pb-36">
          ...
          >
            <div className="relative  mb-1 px-2 md:px-0">
              <h1 className="text-2xl  font-bold mt-7">
                Our Ser<span className="text-orange-400 ">vic</span>e
              </h1>
            ...
            <p className="text-2xl md:text-4xl font-bold px-2 md:px-0">
              Design & Development
            </p>
            <p className="mt-6 text-sm text-gray-500 px-2 md:px-0">
              Web development is the process of building and maintaining
              websites, involving coding, design, and ensuring functionality and
              user experience
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 place-items-center section-container py-10 md:py-20 mb-6 md:mb-0  gap-x-5 ">
          ...
          >
            ...
            <p className="mt-6 text-sm text-black px-2 md:px-0">
              Digital marketing involves leveraging data and technology to
              promote brands, engage audiences, and drive business growth
          ...
          >
            ...
            <div className="flex justify-center items-center">
              ...
              />
              <img
                className="absolute spin-slow w-[60%] md:w-[31%] mt-5 md:mt-0 "
                src={img4}
                alt="spin"
              />
            </div>
        ...
        <div className="grid items-center grid-cols-1 md:grid-cols-2 section-container py-20 gap-x-5 ">
          ...
          >
            {/* here include image  */}
            <div className="flex justify-center items-center relative ">
              <img className="z-10" src={img3} alt="Development" />
              <img className="absolute spin-slow " src={img4} alt="spin" />
            </div>
          </motion.div>
          <motion.div
      ...
      <div className="section-container -mt-[140px] ">
        ...
        <Link
          to={"/services"}
          className="p-4 flex flex-col items-center justify-end mr-1 mt-8"
        >
