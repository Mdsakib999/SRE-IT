    ...
    return (
        <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 mt-[-60px] md:mt-0">
                ...
                <div className=" background-gradient-count w-56 h-56 md:w-80 md:h-80 absolute top-[55%] left-32  rounded-full"></div>
                <div className=" background-gradient-count w-56 h-56 md:w-80 md:h-80 absolute -top-26 -right-20  rounded-full "></div>

                    {/* <img src={img2} alt="" className="bb w-44 h-32 -mb-64 -mr-24 hover:z-20 object-cover rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out rounded-bl-[80px] hover:rounded-bl-lg hidden lg:block " /> */}
